# 1 "linux-2.6.18/arch/x86_64/lib/bitops.c"
...
# 2 "linux-2.6.18/arch/x86_64/lib/bitops.c" 2
...
__find_first_zero_bit(const unsigned long * addr, unsigned long size)
{
        long d0, d1, d2;
        long res;
# 23 "linux-2.6.18/arch/x86_64/lib/bitops.c"
        size += 63;
        size >>= 6;
        if (!size)
                return 0;
...
# 55 "linux-2.6.18/arch/x86_64/lib/bitops.c"
...
__find_first_bit(const unsigned long * addr, unsigned long size)
{
        long d0, d1;
        long res;
# 108 "linux-2.6.18/arch/x86_64/lib/bitops.c"
        size += 63;
        size >>= 6;
        if (!size)
                return 0;
...
# 134 "linux-2.6.18/arch/x86_64/lib/bitops.c"
...
# 171 "linux-2.6.18/arch/x86_64/lib/bitops.c" 2

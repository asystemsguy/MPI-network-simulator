# 1 "linux-2.6.18/arch/x86_64/lib/csum-wrappers.c"
...
# 10 "linux-2.6.18/include/asm/checksum.h"
# 1 "linux-2.6.18/include/linux/compiler.h" 1
# 11 "linux-2.6.18/include/asm/checksum.h" 2
...
# 8 "linux-2.6.18/arch/x86_64/lib/csum-wrappers.c" 2
...
# 9 "linux-2.6.18/arch/x86_64/lib/csum-wrappers.c" 2
# 21 "linux-2.6.18/arch/x86_64/lib/csum-wrappers.c"
unsigned int
        ...
        if (__builtin_expect(!!((1)), 1)) {
                ...
                if (__builtin_expect(!!((unsigned long)src & 6), 0)) {
                        while (((unsigned long)src & 6) && len >= 2) {
                                __u16 val16;
                                *errp = ({ int __gu_err; unsigned long __gu_val; do { __gu_err = 0; (void)0; switch ((sizeof(*((__u16 *)src)))) { case 1: __asm__ __volatile__( "1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__gu_err), "=q" (__gu_val) : "m"((*(struct __large_struct *)((((__u16 *)src))))), "i"(-14), "0"(__gu_err)); break; case 2: __asm__ __volatile__( "1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)((((__u16 *)src))))), "i"(-14), "0"(__gu_err)); break; case 4: __asm__ __volatile__( "1:	mov""l"" %2,%""k""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""l"" %""k""1,%""k""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)((((__u16 *)src))))), "i"(-14), "0"(__gu_err)); break; case 8: __asm__ __volatile__( "1:	mov""q"" %2,%""""1\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	xor""q"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__gu_err), "=r" (__gu_val) : "m"((*(struct __large_struct *)((((__u16 *)src))))), "i"(-14), "0"(__gu_err)); break; default: (__gu_val) = __get_user_bad(); } } while (0); ((val16)) = (__typeof__(*(((__u16 *)src))))__gu_val; __gu_err; });
                                if (*errp)
                                        return isum;
                                *(__u16 *)dst = val16;
                ...
                isum = csum_partial_copy_generic(( void *)src,dst,len,isum,errp,((void *)0));
                if (__builtin_expect(!!(*errp == 0), 1))
                        return isum;
        }
        *errp = -14;
        memset(dst,0,len);
...
;
# 69 "linux-2.6.18/arch/x86_64/lib/csum-wrappers.c"
unsigned int
csum_partial_copy_to_user(unsigned const char *src, unsigned char *dst,
                          int len, unsigned int isum, int *errp)
{
        do { do { } while (0); } while (0);
        ...
        if (__builtin_expect(!!((unsigned long)dst & 6), 0)) {
                while (((unsigned long)dst & 6) && len >= 2) {
                        ...
                        isum = add32_with_carry(isum, val16);
                        *errp = ({ int __pu_err; do { __pu_err = 0; (void)0; switch ((sizeof(*((__u16 *)dst)))) { case 1: __asm__ __volatile__( "1:	mov""b"" %""b""1,%2\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__pu_err) : "iq" (((__typeof__(*((__u16 *)dst)))(val16))), "m"((*(struct __large_struct *)((((__u16 *)dst))))), "i"(-14), "0"(__pu_err)); break; case 2: __asm__ __volatile__( "1:	mov""w"" %""w""1,%2\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__pu_err) : "ir" (((__typeof__(*((__u16 *)dst)))(val16))), "m"((*(struct __large_struct *)((((__u16 *)dst))))), "i"(-14), "0"(__pu_err)); break; case 4: __asm__ __volatile__( "1:	mov""l"" %""k""1,%2\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__pu_err) : "ir" (((__typeof__(*((__u16 *)dst)))(val16))), "m"((*(struct __large_struct *)((((__u16 *)dst))))), "i"(-14), "0"(__pu_err)); break; case 8: __asm__ __volatile__( "1:	mov""q"" %""""1,%2\n" "2:\n" ".section .fixup,\"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" ".section __ex_table,\"a\"\n" "	.align 8\n" "	.quad 1b,3b\n" ".previous" : "=r"(__pu_err) : "ir" (((__typeof__(*((__u16 *)dst)))(val16))), "m"((*(struct __large_struct *)((((__u16 *)dst))))), "i"(-14), "0"(__pu_err)); break; default: __put_user_bad(); } } while (0); __pu_err; });
                        if (*errp)
                                return isum;
                        src += 2;
                        dst += 2;
        ...
        *errp = 0;
        return csum_partial_copy_generic(src, (void *)dst,len,isum,((void *)0),errp);
}

;
# 107 "linux-2.6.18/arch/x86_64/lib/csum-wrappers.c"
unsigned int

...
static int cascade(tvec_base_t *base, tvec_t *tv, int index)
{
 ...
 for (timer = ({ const typeof( ((typeof(*timer) *)0)->entry ) *__mptr = ((&tv_list)->next); (typeof(*timer) *)( (char *)__mptr - ((size_t) &((typeof(*timer) *)0)->entry) );}), tmp = ({ const typeof( ((typeof(*timer) *)0)->entry ) *__mptr = (timer->entry.next); (typeof(*timer) *)( (char *)__mptr - ((size_t) &((typeof(*timer) *)0)->entry) );}); &timer->entry != (&tv_list); timer = tmp, tmp = ({ const typeof( ((typeof(*tmp) *)0)->entry ) *__mptr = (tmp->entry.next); (typeof(*tmp) *)( (char *)__mptr - ((size_t) &((typeof(*tmp) *)0)->entry) );})) {
...
static inline void __run_timers(tvec_base_t *base)
{
 ...
 while ((({ unsigned long __dummy; typeof(global_jiffies[get_stack_id()]) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(base->timer_jiffies) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(global_jiffies[get_stack_id()]) - (long)(base->timer_jiffies) >= 0))) {
  ...
  while (!list_empty(head)) {
   ...
   timer = ({ const typeof( ((struct timer_list *)0)->entry ) *__mptr = (head->next); (struct timer_list *)( (char *)__mptr - ((size_t) &((struct timer_list *)0)->entry) );});
    fn = timer->function;
    data = timer->data;
...
typedef  initcall_t  _GLOBAL_218_T; static  _GLOBAL_218_T  __initcall_timekeeping_init_device __attribute__((__section__(".initcall" "6" ".init")))  = timekeeping_init_device ;      





static inline int clocksource_bigadjust(s64 error, s64 *interval, s64 *offset)
{
 s64 tick_error, i;
 u32 look_ahead, adj;
 s32 error2, mult;

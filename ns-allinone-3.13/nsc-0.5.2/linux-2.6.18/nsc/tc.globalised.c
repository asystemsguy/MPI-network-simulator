...
typedef  kernel_cap_t  _GLOBAL_32_T; extern  _GLOBAL_32_T  global_cap_bset[NUM_STACKS];   
       ...
       int alen)
{
  ...
  rta->rta_type = type;
  rta->rta_len = len;
  ({ size_t __len = (alen); void *__ret; if (__builtin_constant_p(alen) && __len >= 64) __ret = __memcpy((((void*)(((char*)(rta)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),(data),__len); else __ret = __builtin_memcpy((((void*)(((char*)(rta)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),(data),__len); __ret; });

...
typedef  unsigned long   _GLOBAL_191_T; extern  _GLOBAL_191_T  global_loops_per_jiffy[NUM_STACKS];    
...
typedef  struct proc_dir_entry   _GLOBAL_294_T; extern  _GLOBAL_294_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_295_T; extern  _GLOBAL_295_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_296_T; extern  _GLOBAL_296_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_297_T; extern  _GLOBAL_297_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_298_T; extern  _GLOBAL_298_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_299_T; extern  _GLOBAL_299_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_300_T; extern  _GLOBAL_300_T  * global_proc_root_kcore[NUM_STACKS];    

typedef  spinlock_t  _GLOBAL_301_T; extern  _GLOBAL_301_T  global_proc_subdir_lock[NUM_STACKS];   
...
typedef  struct vfsmount   _GLOBAL_302_T; extern  _GLOBAL_302_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  const struct file_operations    _GLOBAL_303_T; extern  _GLOBAL_303_T  global_proc_kcore_operations[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_304_T; extern  _GLOBAL_304_T  global_proc_kmsg_operations[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_305_T; extern  _GLOBAL_305_T  global_ppc_htab_operations[NUM_STACKS];     
...
typedef  struct proc_dir_entry   _GLOBAL_306_T; extern  _GLOBAL_306_T  * global_proc_net[NUM_STACKS]; extern  _GLOBAL_306_T  * global_proc_sys_root[NUM_STACKS];     
typedef  int  _GLOBAL_307_T; extern  _GLOBAL_307_T  global_nsc_g_l26_diagnostic[NUM_STACKS];   

void nsc_sysctl_a(void);
struct thread_info *nsc_get_current_thread_info(void);

typedef  struct task_struct  _GLOBAL_308_T;  _GLOBAL_308_T  * global_nsc_task[NUM_STACKS];   
void timekeeping_init(void);
...
void nsc_init(void)
{
    ...
    memset(global_nsc_task[get_stack_id()], 0, sizeof(*global_nsc_task[get_stack_id()]));

    get_nsc_task()->cap_effective = 0xFFFFFFFF;
    get_nsc_task()->euid = 0;
    get_nsc_task()->thread_info = (struct thread_info *)nsc_malloc(sizeof(struct thread_info));
    memset(get_nsc_task()->thread_info, 0, sizeof(struct thread_info));
...
typedef  unsigned long    _GLOBAL_309_T; extern volatile  _GLOBAL_309_T  global_jiffies[NUM_STACKS];     
...
# 182 "linux-2.6.18/nsc/support.c"
    ...
    ({ size_t __len = (datalen); void *__ret; if (__builtin_constant_p(datalen) && __len >= 64) __ret = __memcpy((skb_put(skb, datalen)),(data),__len); else __ret = __builtin_memcpy((skb_put(skb, datalen)),(data),__len); __ret; });
...
{
  typedef  int  _GLOBAL_310_T; extern  _GLOBAL_310_T  global_nsc_cpuset_netclass_id[NUM_STACKS];   

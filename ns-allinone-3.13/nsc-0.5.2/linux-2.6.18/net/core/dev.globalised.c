...
void __dev_remove_pack(struct packet_type *pt)
{
 ...
 for (pt1 = ({ const typeof( ((typeof(*pt1) *)0)->list ) *__mptr = ((head)->next); (typeof(*pt1) *)( (char *)__mptr - ((size_t) &((typeof(*pt1) *)0)->list) );}); prefetch(pt1->list.next), &pt1->list != (head); pt1 = ({ const typeof( ((typeof(*pt1) *)0)->list ) *__mptr = (pt1->list.next); (typeof(*pt1) *)( (char *)__mptr - ((size_t) &((typeof(*pt1) *)0)->list) );})) {
  if (pt == pt1) {
...
struct net_device *__dev_get_by_name(const char *name)
{
 ...
 for (p = (dev_name_hash(name))->first; p && ({ prefetch(p->next); 1; }); p = p->next) {
  struct net_device *dev
   = ({ const typeof( ((struct net_device *)0)->name_hlist ) *__mptr = (p); (struct net_device *)( (char *)__mptr - ((size_t) &((struct net_device *)0)->name_hlist) );});
...
struct net_device *__dev_get_by_index(int ifindex)
{
 ...
 for (p = (dev_index_hash(ifindex))->first; p && ({ prefetch(p->next); 1; }); p = p->next) {
  struct net_device *dev
   = ({ const typeof( ((struct net_device *)0)->index_hlist ) *__mptr = (p); (struct net_device *)( (char *)__mptr - ((size_t) &((struct net_device *)0)->index_hlist) );});
...
struct sk_buff *skb_gso_segment(struct sk_buff *skb, int features)
{
 ...
 do { do { } while (0); (void)0; } while(0);
 for (ptype = ({ const typeof( ((typeof(*ptype) *)0)->list ) *__mptr = ((&(*_GLOBAL_ptype_base_33_A[get_stack_id()])[ntohs(type) & 15])->next); (typeof(*ptype) *)( (char *)__mptr - ((size_t) &((typeof(*ptype) *)0)->list) );}); prefetch(({ typeof(ptype) _________p1 = ptype; do {} while(0); (_________p1); })->list.next), &ptype->list != (&(*_GLOBAL_ptype_base_33_A[get_stack_id()])[ntohs(type) & 15]); ptype = ({ const typeof( ((typeof(*ptype) *)0)->list ) *__mptr = (ptype->list.next); (typeof(*ptype) *)( (char *)__mptr - ((size_t) &((typeof(*ptype) *)0)->list) );})) {
...
static void net_rx_action(struct softirq_action *h)
{
 ...
 while (!list_empty(&queue->poll_list)) {
  ...
  dev = ({ const typeof( ((struct net_device *)0)->poll_list ) *__mptr = (queue->poll_list.next); (struct net_device *)( (char *)__mptr - ((size_t) &((struct net_device *)0)->poll_list) );})
                                  ;
  have = ((void *)0);
...
void netdev_run_todo(void)
{
 ...
 while (!list_empty(&list)) {
  struct net_device *dev
   = ({ const typeof( ((struct net_device *)0)->todo_list ) *__mptr = (list.next); (struct net_device *)( (char *)__mptr - ((size_t) &((struct net_device *)0)->todo_list) );});
...
typedef  initcall_t  _GLOBAL_257_T; static  _GLOBAL_257_T  __initcall_net_dev_init __attribute__((__section__(".initcall" "4" ".init")))  = net_dev_init ;      

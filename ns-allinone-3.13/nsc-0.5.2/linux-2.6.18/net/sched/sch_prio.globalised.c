...
static void  __attribute__ ((__section__(".exit.text"))) prio_module_exit(void)
{
 unregister_qdisc(&global_prio_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_243_T; static  _GLOBAL_243_T  __initcall_prio_module_init __attribute__((__section__(".initcall" "6" ".init")))  = prio_module_init ;      
typedef  exitcall_t  _GLOBAL_244_T; static  _GLOBAL_244_T  global___exitcall_prio_module_exit[NUM_STACKS] __attribute__ ((__section__ (".exitcall.exit")))   = {  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  prio_module_exit,  };      

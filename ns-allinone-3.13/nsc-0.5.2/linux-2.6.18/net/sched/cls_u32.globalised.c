...
static void  __attribute__ ((__section__(".exit.text"))) exit_u32(void)
{
 unregister_tcf_proto_ops(&global_cls_u32_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_244_T; static  _GLOBAL_244_T  __initcall_init_u32 __attribute__((__section__(".initcall" "6" ".init")))  = init_u32 ;      

...
static void  __attribute__ ((__section__(".exit.text"))) red_module_exit(void)
{
 unregister_qdisc(&global_red_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_214_T; static  _GLOBAL_214_T  __initcall_red_module_init __attribute__((__section__(".initcall" "6" ".init")))  = red_module_init ;      

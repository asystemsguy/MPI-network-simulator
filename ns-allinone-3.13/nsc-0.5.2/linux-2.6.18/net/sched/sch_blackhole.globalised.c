...
static void  __attribute__ ((__section__(".exit.text"))) blackhole_module_exit(void)
{
 unregister_qdisc(&global_blackhole_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_199_T; static  _GLOBAL_199_T  __initcall_blackhole_module_init __attribute__((__section__(".initcall" "6" ".init")))  = blackhole_module_init ;      

...
static void  __attribute__ ((__section__(".exit.text"))) exit_tcindex(void)
{
 unregister_tcf_proto_ops(&global_cls_tcindex_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_242_T; static  _GLOBAL_242_T  __initcall_init_tcindex __attribute__((__section__(".initcall" "6" ".init")))  = init_tcindex ;      

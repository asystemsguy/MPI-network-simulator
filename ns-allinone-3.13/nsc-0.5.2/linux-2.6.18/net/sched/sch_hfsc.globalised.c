...
eltree_insert(struct hfsc_class *cl)
{
 ...
 while (*p != ((void *)0)) {
  parent = *p;
  cl1 = ({ const typeof( ((struct hfsc_class *)0)->el_node ) *__mptr = (parent); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->el_node) );});
  if (cl->cl_e >= cl1->cl_e)
   p = &parent->rb_right;
  else
   p = &parent->rb_left;
...
eltree_get_mindl(struct hfsc_sched *q, u64 cur_time)
{
 ...
 for (n = rb_first(&q->eligible); n != ((void *)0); n = rb_next(n)) {
  p = ({ const typeof( ((struct hfsc_class *)0)->el_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->el_node) );});
  if (p->cl_e > cur_time)
   break;
...
eltree_get_minel(struct hfsc_sched *q)
{
 ...
 if (n == ((void *)0))
  return ((void *)0);
 return ({ const typeof( ((struct hfsc_class *)0)->el_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->el_node) );});
}
...
vttree_insert(struct hfsc_class *cl)
{
 ...
 while (*p != ((void *)0)) {
  parent = *p;
  cl1 = ({ const typeof( ((struct hfsc_class *)0)->vt_node ) *__mptr = (parent); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->vt_node) );});
...
vttree_firstfit(struct hfsc_class *cl, u64 cur_time)
{
 ...
 for (n = rb_first(&cl->vt_tree); n != ((void *)0); n = rb_next(n)) {
  p = ({ const typeof( ((struct hfsc_class *)0)->vt_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->vt_node) );});
  if (p->cl_f <= cur_time)
   return p;
 }
 return ((void *)0);
...
cftree_insert(struct hfsc_class *cl)
{
 ...
 while (*p != ((void *)0)) {
  parent = *p;
  cl1 = ({ const typeof( ((struct hfsc_class *)0)->cf_node ) *__mptr = (parent); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->cf_node) );});
  if (cl->cl_f >= cl1->cl_f)
   p = &parent->rb_right;
  else
   p = &parent->rb_left;
...
update_cfmin(struct hfsc_class *cl)
{
 ...
 p = ({ const typeof( ((struct hfsc_class *)0)->cf_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->cf_node) );});
 cl->cl_cfmin = p->cl_f;
}
...
init_vf(struct hfsc_class *cl, unsigned int len)
{
 ...
 for (; cl->cl_parent != ((void *)0); cl = cl->cl_parent) {
  ...
  if (go_active) {
   ...
   if (n != ((void *)0)) {
    max_cl = ({ const typeof( ((struct hfsc_class *)0)->vt_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - ((size_t) &((struct hfsc_class *)0)->vt_node) );});
...
hfsc_adjust_levels(struct hfsc_class *cl)
{
 ...
 do {
  level = 0;
  for (p = ({ const typeof( ((typeof(*p) *)0)->siblings ) *__mptr = ((&cl->children)->next); (typeof(*p) *)( (char *)__mptr - ((size_t) &((typeof(*p) *)0)->siblings) );}); prefetch(p->siblings.next), &p->siblings != (&cl->children); p = ({ const typeof( ((typeof(*p) *)0)->siblings ) *__mptr = (p->siblings.next); (typeof(*p) *)( (char *)__mptr - ((size_t) &((typeof(*p) *)0)->siblings) );})) {
   if (p->level >= level)
    level = p->level + 1;
  }
  cl->level = level;
...
hfsc_find_class(u32 classid, struct Qdisc *sch)
{
 ...
 for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[hfsc_hash(classid)])->next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->hlist) );}); prefetch(cl->hlist.next), &cl->hlist != (&q->clhash[hfsc_hash(classid)]); cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->hlist) );})) {
...
hfsc_walk(struct Qdisc *sch, struct qdisc_walker *arg)
{
 ...
 for (i = 0; i < 16; i++) {
  for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[i])->next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->hlist) );}); prefetch(cl->hlist.next), &cl->hlist != (&q->clhash[i]); cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->hlist) );})) {
...
hfsc_destroy_qdisc(struct Qdisc *sch)
{
 ...
 for (i = 0; i < 16; i++) {
  for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[i])->next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->hlist) );}), next = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->hlist) );}); &cl->hlist != (&q->clhash[i]); cl = next, next = ({ const typeof( ((typeof(*next) *)0)->hlist ) *__mptr = (next->hlist.next); (typeof(*next) *)( (char *)__mptr - ((size_t) &((typeof(*next) *)0)->hlist) );}))
   hfsc_destroy_class(sch, cl);
 }
 __skb_queue_purge(&q->requeue);
 del_timer(&q->wd_timer);
...
hfsc_drop(struct Qdisc *sch)
{
 ...
 for (cl = ({ const typeof( ((typeof(*cl) *)0)->dlist ) *__mptr = ((&q->droplist)->next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->dlist) );}); prefetch(cl->dlist.next), &cl->dlist != (&q->droplist); cl = ({ const typeof( ((typeof(*cl) *)0)->dlist ) *__mptr = (cl->dlist.next); (typeof(*cl) *)( (char *)__mptr - ((size_t) &((typeof(*cl) *)0)->dlist) );})) {

...
{
 struct Qdisc *qdisc = ({ const typeof( ((struct Qdisc *)0)->q_rcu ) *__mptr = (head); (struct Qdisc *)( (char *)__mptr - ((size_t) &((struct Qdisc *)0)->q_rcu) );});
 struct Qdisc_ops *ops = qdisc->ops;
...
void qdisc_destroy(struct Qdisc *qdisc)
{
 ...
 for (cq = ({ const typeof( ((typeof(*cq) *)0)->list ) *__mptr = ((&cql)->next); (typeof(*cq) *)( (char *)__mptr - ((size_t) &((typeof(*cq) *)0)->list) );}); prefetch(cq->list.next), &cq->list != (&cql); cq = ({ const typeof( ((typeof(*cq) *)0)->list ) *__mptr = (cq->list.next); (typeof(*cq) *)( (char *)__mptr - ((size_t) &((typeof(*cq) *)0)->list) );}))
  for (q = ({ const typeof( ((typeof(*q) *)0)->list ) *__mptr = ((&qdisc->dev->qdisc_list)->next); (typeof(*q) *)( (char *)__mptr - ((size_t) &((typeof(*q) *)0)->list) );}), n = ({ const typeof( ((typeof(*q) *)0)->list ) *__mptr = (q->list.next); (typeof(*q) *)( (char *)__mptr - ((size_t) &((typeof(*q) *)0)->list) );}); &q->list != (&qdisc->dev->qdisc_list); q = n, n = ({ const typeof( ((typeof(*n) *)0)->list ) *__mptr = (n->list.next); (typeof(*n) *)( (char *)__mptr - ((size_t) &((typeof(*n) *)0)->list) );}))
 ...
 for (cq = ({ const typeof( ((typeof(*cq) *)0)->list ) *__mptr = ((&cql)->next); (typeof(*cq) *)( (char *)__mptr - ((size_t) &((typeof(*cq) *)0)->list) );}), n = ({ const typeof( ((typeof(*cq) *)0)->list ) *__mptr = (cq->list.next); (typeof(*cq) *)( (char *)__mptr - ((size_t) &((typeof(*cq) *)0)->list) );}); &cq->list != (&cql); cq = n, n = ({ const typeof( ((typeof(*n) *)0)->list ) *__mptr = (n->list.next); (typeof(*n) *)( (char *)__mptr - ((size_t) &((typeof(*n) *)0)->list) );}))
...
void dev_activate(struct net_device *dev)
{
 ...
 do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&dev->queue_lock); } while (0); } while (0);
 ({ __memory_barrier(); (dev->qdisc) = (dev->qdisc_sleeping); });

...
static void  __attribute__ ((__section__(".exit.text"))) atm_exit(void)
{
 unregister_qdisc(&global_atm_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_226_T; static  _GLOBAL_226_T  __initcall_atm_init __attribute__((__section__(".initcall" "6" ".init")))  = atm_init ;      

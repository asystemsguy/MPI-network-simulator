...
static __inline__ struct htb_class *htb_find(u32 handle, struct Qdisc *sch)
{
 ...
 for (p = (q->hash+htb_hash(handle))->next; prefetch(p->next), p != (q->hash+htb_hash(handle)); p = p->next) {
  struct htb_class *cl = ({ const typeof( ((struct htb_class *)0)->hlist ) *__mptr = (p); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->hlist) );});
...
# 422 "linux-2.6.18/net/sched/sch_htb.c"
 while (*p) {
  ...
  c = ({ const typeof( ((struct htb_class *)0)->node[prio] ) *__mptr = (parent); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->node[prio]) );});
  ;
  ...
  struct htb_class *cl,long delay,int debug_hint)
{
 ...
 while (*p) {
  struct htb_class *c; parent = *p;
  c = ({ const typeof( ((struct htb_class *)0)->pq_node ) *__mptr = (parent); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->pq_node) );});
...
static long htb_do_events(struct htb_sched *q,int level)
{
 ...
 for (i = 0; i < 500; i++) {
  ...
  cl = ({ const typeof( ((struct htb_class *)0)->pq_node ) *__mptr = (p); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->pq_node) );});
...
htb_id_find_next_upper(int prio,struct rb_node *n,u32 id)
{
 ...
 while (n) {
  struct htb_class *cl = ({ const typeof( ((struct htb_class *)0)->node[prio] ) *__mptr = (n); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->node[prio]) );});
...
htb_lookup_leaf( struct rb_root *tree,int prio,struct rb_node **pptr,u32 *pid)
{
  ...
  *sp->pid = 0;
   ...
   *sp->pptr = sp->root;
   ...
   struct htb_class *cl;
   cl = ({ const typeof( ((struct htb_class *)0)->node[prio] ) *__mptr = (*sp->pptr); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->node[prio]) );});
   ;
   if (!cl->level)
    return cl;
...
static unsigned int htb_drop(struct Qdisc* sch)
{
 ...
 for (prio = 8 - 1; prio >= 0; prio--) {
  ...
  for (p = (q->drops+prio)->next; prefetch(p->next), p != (q->drops+prio); p = p->next) {
   struct htb_class *cl = ({ const typeof( ((struct htb_class *)0)->un.leaf.drop_list ) *__mptr = (p); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->un.leaf.drop_list) );})
                           ;
   unsigned int len;
...
static void htb_destroy_class(struct Qdisc* sch,struct htb_class *cl)
{
 ...
 while (!list_empty(&cl->children))
  htb_destroy_class (sch,({ const typeof( ((struct htb_class *)0)->sibling ) *__mptr = (cl->children.next); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->sibling) );})
                              );
...
static void htb_destroy(struct Qdisc* sch)
{
 ...
 while (!list_empty(&q->root))
  htb_destroy_class (sch,({ const typeof( ((struct htb_class *)0)->sibling ) *__mptr = (q->root.next); (struct htb_class *)( (char *)__mptr - ((size_t) &((struct htb_class *)0)->sibling) );})
                              );
...
static void  __attribute__ ((__section__(".exit.text"))) htb_module_exit(void)
{
    unregister_qdisc(&global_htb_qdisc_ops[get_stack_id()]);
}
typedef  initcall_t  _GLOBAL_243_T; static  _GLOBAL_243_T  __initcall_htb_module_init __attribute__((__section__(".initcall" "6" ".init")))  = htb_module_init ;      
typedef  exitcall_t  _GLOBAL_244_T; static  _GLOBAL_244_T  global___exitcall_htb_module_exit[NUM_STACKS] __attribute__ ((__section__ (".exitcall.exit")))   = {  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  htb_module_exit,  };      
;

...
static void  __attribute__ ((__section__(".exit.text"))) exit_rsvp(void)
{
 unregister_tcf_proto_ops(&global_cls_rsvp_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_243_T; static  _GLOBAL_243_T  __initcall_init_rsvp __attribute__((__section__(".initcall" "6" ".init")))  = init_rsvp ;      

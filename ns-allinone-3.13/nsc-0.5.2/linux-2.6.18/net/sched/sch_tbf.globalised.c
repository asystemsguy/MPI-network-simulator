...
static void  __attribute__ ((__section__(".exit.text"))) tbf_module_exit(void)
{
 unregister_qdisc(&global_tbf_qdisc_ops[get_stack_id()]);
}
typedef  initcall_t  _GLOBAL_243_T; static  _GLOBAL_243_T  __initcall_tbf_module_init __attribute__((__section__(".initcall" "6" ".init")))  = tbf_module_init ;      

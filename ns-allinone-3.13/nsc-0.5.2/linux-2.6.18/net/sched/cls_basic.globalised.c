     ...
     struct tcf_result *res)
{
 ...
 for (f = ({ const typeof( ((typeof(*f) *)0)->link ) *__mptr = ((&head->flist)->next); (typeof(*f) *)( (char *)__mptr - ((size_t) &((typeof(*f) *)0)->link) );}); prefetch(f->link.next), &f->link != (&head->flist); f = ({ const typeof( ((typeof(*f) *)0)->link ) *__mptr = (f->link.next); (typeof(*f) *)( (char *)__mptr - ((size_t) &((typeof(*f) *)0)->link) );})) {
  if (!((void)(((void *)0)), 1))
   continue;
  *res = f->res;
...
static void basic_destroy(struct tcf_proto *tp)
{
 ...
 for (f = ({ const typeof( ((typeof(*f) *)0)->link ) *__mptr = ((&head->flist)->next); (typeof(*f) *)( (char *)__mptr - ((size_t) &((typeof(*f) *)0)->link) );}), n = ({ const typeof( ((typeof(*f) *)0)->link ) *__mptr = (f->link.next); (typeof(*f) *)( (char *)__mptr - ((size_t) &((typeof(*f) *)0)->link) );}); &f->link != (&head->flist); f = n, n = ({ const typeof( ((typeof(*n) *)0)->link ) *__mptr = (n->link.next); (typeof(*n) *)( (char *)__mptr - ((size_t) &((typeof(*n) *)0)->link) );})) {
  list_del(&f->link);
...
static int basic_delete(struct tcf_proto *tp, unsigned long arg)
{
 ...
 for (t = ({ const typeof( ((typeof(*t) *)0)->link ) *__mptr = ((&head->flist)->next); (typeof(*t) *)( (char *)__mptr - ((size_t) &((typeof(*t) *)0)->link) );}); prefetch(t->link.next), &t->link != (&head->flist); t = ({ const typeof( ((typeof(*t) *)0)->link ) *__mptr = (t->link.next); (typeof(*t) *)( (char *)__mptr - ((size_t) &((typeof(*t) *)0)->link) );}))
  if (t == f) {
   qdisc_lock_tree((tp)->q->dev);
   list_del(&t->link);
   qdisc_unlock_tree((tp)->q->dev);

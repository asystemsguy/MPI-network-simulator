...
static void  __attribute__ ((__section__(".exit.text"))) teql_exit(void)
{
 struct teql_master *master, *nxt;

 for (master = ({ const typeof( ((typeof(*master) *)0)->master_list ) *__mptr = ((&global_master_dev_list[get_stack_id()])->next); (typeof(*master) *)( (char *)__mptr - ((size_t) &((typeof(*master) *)0)->master_list) );}), nxt = ({ const typeof( ((typeof(*master) *)0)->master_list ) *__mptr = (master->master_list.next); (typeof(*master) *)( (char *)__mptr - ((size_t) &((typeof(*master) *)0)->master_list) );}); &master->master_list != (&global_master_dev_list[get_stack_id()]); master = nxt, nxt = ({ const typeof( ((typeof(*nxt) *)0)->master_list ) *__mptr = (nxt->master_list.next); (typeof(*nxt) *)( (char *)__mptr - ((size_t) &((typeof(*nxt) *)0)->master_list) );})) {
...
typedef  initcall_t  _GLOBAL_245_T; static  _GLOBAL_245_T  __initcall_teql_init __attribute__((__section__(".initcall" "6" ".init")))  = teql_init ;      ;

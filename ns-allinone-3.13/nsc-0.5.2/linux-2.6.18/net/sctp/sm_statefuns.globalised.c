# 1 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sctp/sm_statefuns.c"
# 55 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 56 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
# 57 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
# 58 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
# 59 "linux-2.6.18/net/sctp/sm_statefuns.c" 2

# 1 "linux-2.6.18/include/linux/inet.h" 1
# 48 "linux-2.6.18/include/linux/inet.h"
extern __be32 in_aton(const char *str);
# 61 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
# 63 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
typedef  struct list_head   _GLOBAL_207_T; extern  _GLOBAL_207_T  global_tty_drivers[NUM_STACKS];    
...
typedef  struct termios   _GLOBAL_208_T; extern  _GLOBAL_208_T  global_tty_std_termios[NUM_STACKS];    

typedef  int  _GLOBAL_209_T; extern  _GLOBAL_209_T  global_kmsg_redirect[NUM_STACKS];   
...
typedef  struct mutex   _GLOBAL_210_T; extern  _GLOBAL_210_T  global_tty_mutex[NUM_STACKS];    


typedef  struct tty_ldisc   _GLOBAL_211_T; extern  _GLOBAL_211_T  global_tty_ldisc_N_TTY[NUM_STACKS];    
...
typedef  struct proc_dir_entry   _GLOBAL_212_T; extern  _GLOBAL_212_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_213_T; extern  _GLOBAL_213_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_214_T; extern  _GLOBAL_214_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_215_T; extern  _GLOBAL_215_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_216_T; extern  _GLOBAL_216_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_217_T; extern  _GLOBAL_217_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_218_T; extern  _GLOBAL_218_T  * global_proc_root_kcore[NUM_STACKS];    

typedef  spinlock_t  _GLOBAL_219_T; extern  _GLOBAL_219_T  global_proc_subdir_lock[NUM_STACKS];   
...
typedef  struct vfsmount   _GLOBAL_220_T; extern  _GLOBAL_220_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  const struct file_operations    _GLOBAL_221_T; extern  _GLOBAL_221_T  global_proc_kcore_operations[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_222_T; extern  _GLOBAL_222_T  global_proc_kmsg_operations[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_223_T; extern  _GLOBAL_223_T  global_ppc_htab_operations[NUM_STACKS];     
...
# 65 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
# 66 "linux-2.6.18/net/sctp/sm_statefuns.c" 2
...
static sctp_disposition_t sctp_sf_violation_chunklen(
         ...
         void *arg,
         sctp_cmd_seq_t *commands);
# 114 "linux-2.6.18/net/sctp/sm_statefuns.c"
static inline int
      ...
      __u16 required_length)
{
 ...
 if (__builtin_expect(!!(chunk_length < required_length), 0))
  return 0;

 return 1;
}
# 161 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 188 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 203 "linux-2.6.18/net/sctp/sm_statefuns.c"
 ...
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_SHUTDOWNS]++);
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_CURRESTAB]--);
...
# 245 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 struct sock *sk;
 int len;
# 269 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (!chunk->singleton)
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
 ...
 if (!__sctp_sstate((sk), (SCTP_SS_LISTENING)) ||
     (__sctp_style((sk), (SCTP_SOCKET_TCP)) &&
  ...
  if (err_chunk) {
   ...
   if (packet) {
    sctp_add_cmd_sf(commands, SCTP_CMD_SEND_PKT,
      SCTP_PACKET(packet));
    (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_OUTCTRLCHUNKS]++);
 ...
 new_asoc = sctp_make_temp_asoc(ep, chunk, ((( gfp_t)0x20u)));
 if (!new_asoc)
  goto nomem;
 ...
 if (sctp_assoc_set_bind_addr_from_ep(new_asoc, ((( gfp_t)0x20u))) < 0)
  goto nomem_ack;

 repl = sctp_make_init_ack(new_asoc, chunk, ((( gfp_t)0x20u)), len);
 if (!repl)
  goto nomem_ack;
...
# 440 "linux-2.6.18/net/sctp/sm_statefuns.c"
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 if (!sctp_verify_init(asoc, chunk->chunk_hdr->type,
  ...
  (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_ABORTEDS]++);
  ...
  return sctp_stop_t1_and_abort(commands, error, 111,
...
# 594 "linux-2.6.18/net/sctp/sm_statefuns.c"
          ...
          sctp_cmd_seq_t *commands)
{
 ...
 new_asoc = sctp_unpack_cookie(ep, asoc, chunk, ((( gfp_t)0x20u)), &error,
          &err_chk_p);
 ...
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_CURRESTAB]++);
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_PASSIVEESTABS]++);
...
# 756 "linux-2.6.18/net/sctp/sm_statefuns.c"
          ...
          sctp_cmd_seq_t *commands)
{
 ...
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
   SCTP_STATE(SCTP_STATE_ESTABLISHED));
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_CURRESTAB]++);
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_ACTIVEESTABS]++);
 sctp_add_cmd_sf(commands, SCTP_CMD_HB_TIMERS_START, SCTP_NULL());
 if (asoc->autoclose)
  sctp_add_cmd_sf(commands, SCTP_CMD_TIMER_START,
    SCTP_TO(SCTP_EVENT_TIMEOUT_AUTOCLOSE));
 ...
 if (asoc->peer.adaption_ind) {
  ev = sctp_ulpevent_make_adaption_indication(asoc, ((( gfp_t)0x20u)));
  if (!ev)
   goto nomem;
         ...
         sctp_cmd_seq_t *commands)
{
 ...
 hbinfo.sent_at = global_jiffies[get_stack_id()];
...
# 894 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 935 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1002 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 if (__builtin_expect(!!(!link), 0)) {
  if (from_addr.sa.sa_family == 10) {
   printk("<4>"
          "%s association %p could not find address "
          "%04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x" "\n",
          (__func__),
          asoc,
          ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[0]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[1]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[2]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[3]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[4]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[5]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[6]), ntohs((from_addr.v6.sin6_addr).in6_u.u6_addr16[7]));
  } else {
   printk("<4>"
          "%s association %p could not find address "
          "%u.%u.%u.%u" "\n",
          (__func__),
          asoc,
          ((unsigned char *)&from_addr.v4.sin_addr.s_addr)[0], ((unsigned char *)&from_addr.v4.sin_addr.s_addr)[1], ((unsigned char *)&from_addr.v4.sin_addr.s_addr)[2], ((unsigned char *)&from_addr.v4.sin_addr.s_addr)[3]);
  }
  return SCTP_DISPOSITION_DISCARD;
 }
 ...
 if ((({ unsigned long __dummy; typeof(hbinfo->sent_at) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(global_jiffies[get_stack_id()]) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(global_jiffies[get_stack_id()]) - (long)(hbinfo->sent_at) < 0)) ||
     (({ unsigned long __dummy; typeof(global_jiffies[get_stack_id()]) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(hbinfo->sent_at + max_interval) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(hbinfo->sent_at + max_interval) - (long)(global_jiffies[get_stack_id()]) < 0))) {
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 int found;
# 1153 "linux-2.6.18/net/sctp/sm_statefuns.c"
 new_addr = ((void *)0);
 found = 0;

 for (pos = (&new_asoc->peer.transport_addr_list)->next; prefetch(pos->next), pos != (&new_asoc->peer.transport_addr_list); pos = pos->next) {
  new_addr = ({ const typeof( ((struct sctp_transport *)0)->transports ) *__mptr = (pos); (struct sctp_transport *)( (char *)__mptr - ((size_t) &((struct sctp_transport *)0)->transports) );});
  found = 0;
  for (pos2 = (&asoc->peer.transport_addr_list)->next; prefetch(pos2->next), pos2 != (&asoc->peer.transport_addr_list); pos2 = pos2->next) {
   addr = ({ const typeof( ((struct sctp_transport *)0)->transports ) *__mptr = (pos2); (struct sctp_transport *)( (char *)__mptr - ((size_t) &((struct sctp_transport *)0)->transports) );})
                  ;
...
# 1233 "linux-2.6.18/net/sctp/sm_statefuns.c"
 ...
 void *arg, sctp_cmd_seq_t *commands)
{
 ...
 sctp_unrecognized_param_t *unk_param;
 int len;
# 1293 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (!chunk->singleton)
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
...
# 1352 "linux-2.6.18/net/sctp/sm_statefuns.c"
 new_asoc = sctp_make_temp_asoc(ep, chunk, ((( gfp_t)0x20u)));
 if (!new_asoc)
  goto nomem;
 ...
 if (!__sctp_state((asoc), (SCTP_STATE_COOKIE_WAIT))) {
...
# 1484 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1537 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1556 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     struct sctp_association *new_asoc)
{
 ...
 if (__sctp_state((asoc), (SCTP_STATE_SHUTDOWN_ACK_SENT))) {
...
# 1648 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1727 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1748 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     struct sctp_association *new_asoc)
{
 ...
 struct sctp_chunk *repl;
# 1765 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (asoc->state < SCTP_STATE_ESTABLISHED) {
  ...
  sctp_add_cmd_sf(commands, SCTP_CMD_HB_TIMERS_START,
    SCTP_NULL());
# 1781 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 1839 "linux-2.6.18/net/sctp/sm_statefuns.c"
 ...
 sctp_cmd_seq_t *commands)
{
 ...
 if (!sctp_vtag_verify_either(chunk, asoc))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
# 1969 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 if (!sctp_vtag_verify_either(chunk, asoc))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
# 2005 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (!sctp_chunk_length_valid(chunk, sizeof(sctp_abort_chunk_t)))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
...
# 2051 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 for ((err) = (sctp_errhdr_t *)((void *)(chunk->chunk_hdr) + sizeof(sctp_chunkhdr_t)); (void *)(err) <= (void *)(chunk->chunk_hdr) + ntohs((chunk->chunk_hdr)->length) - sizeof(sctp_errhdr_t) && (void *)(err) <= (void *)(chunk->chunk_hdr) + ntohs((chunk->chunk_hdr)->length) - ntohs((err)->length) && ntohs((err)->length) >= sizeof(sctp_errhdr_t); (err) = (sctp_errhdr_t *)((void *)(err) + (((ntohs((err)->length))+3)&~3))) {
...
# 2114 "linux-2.6.18/net/sctp/sm_statefuns.c"
static sctp_disposition_t sctp_sf_do_5_2_6_stale(const struct sctp_endpoint *ep,
       const struct sctp_association *asoc,
       const sctp_subtype_t type,
       void *arg,
...
# 2152 "linux-2.6.18/net/sctp/sm_statefuns.c"
 ...
 reply = sctp_make_init(asoc, bp, ((( gfp_t)0x20u)), sizeof(bht));
 if (!reply)
  goto nomem;
...
# 2236 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 if (!sctp_vtag_verify_either(chunk, asoc))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
# 2259 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (!sctp_chunk_length_valid(chunk, sizeof(sctp_abort_chunk_t)))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
 ...
 sctp_add_cmd_sf(commands, SCTP_CMD_SET_SK_ERR, SCTP_ERROR(104));
         ...
         sctp_cmd_seq_t *commands)
{
 ...
 if (!sctp_vtag_verify_either(chunk, asoc))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
# 2304 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (!sctp_chunk_length_valid(chunk, sizeof(sctp_abort_chunk_t)))
  return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
 ...
 return sctp_stop_t1_and_abort(commands, error, 111, asoc,
          chunk->transport);
}
...
# 2401 "linux-2.6.18/net/sctp/sm_statefuns.c"
        ...
        sctp_cmd_seq_t *commands)
{
 ...
 ev = sctp_ulpevent_make_shutdown_event(asoc, 0, ((( gfp_t)0x20u)));
 if (!ev) {
...
# 2473 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 2531 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 2585 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 2641 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 2703 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
discard_force:
# 2723 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (chunk->end_of_packet)
...
# 2753 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 2794 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (chunk->end_of_packet) {
...
# 2840 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 2905 "linux-2.6.18/net/sctp/sm_statefuns.c"
     ...
     sctp_cmd_seq_t *commands)
{
 ...
 if (packet) {
  ...
  if (((abort)->chunk_hdr->flags & SCTP_CHUNK_FLAG_T))
...
# 2955 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3003 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3081 "linux-2.6.18/net/sctp/sm_statefuns.c"
    ...
    sctp_cmd_seq_t *commands)
{
 ...
 (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_OUTOFBLUES]++);
...
# 3148 "linux-2.6.18/net/sctp/sm_statefuns.c"
static sctp_disposition_t sctp_sf_shut_8_4_5(const struct sctp_endpoint *ep,
          const struct sctp_association *asoc,
          const sctp_subtype_t type,
          void *arg,
          sctp_cmd_seq_t *commands)
{
 ...
 if (packet) {
  ...
  if (((shut)->chunk_hdr->flags & SCTP_CHUNK_FLAG_T))
   packet->vtag = ntohl(chunk->sctp_hdr->vtag);
...
# 3207 "linux-2.6.18/net/sctp/sm_statefuns.c"
      ...
      sctp_cmd_seq_t *commands)
{
 ...
 if (ADDIP_SERIAL_gte(rcvd_serial, sent_serial + 1) &&
  ...
  if (abort) {
   sctp_init_cause(abort, SCTP_ERROR_ASCONF_ACK, ((void *)0), 0);
   sctp_add_cmd_sf(commands, SCTP_CMD_REPLY,
     SCTP_CHUNK(abort));
  }
 ...
 if ((rcvd_serial == sent_serial) && asoc->addip_last_asconf) {
  ...
  abort = sctp_make_abort(asoc, asconf_ack,
     sizeof(sctp_errhdr_t));
  if (abort) {
   sctp_init_cause(abort, SCTP_ERROR_RSRC_LOW, ((void *)0), 0);
   sctp_add_cmd_sf(commands, SCTP_CMD_REPLY,
     SCTP_CHUNK(abort));
  }
...
# 3399 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3540 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3621 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3649 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3675 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3704 "linux-2.6.18/net/sctp/sm_statefuns.c"
static sctp_disposition_t sctp_sf_violation_chunklen(
         const struct sctp_endpoint *ep,
         const struct sctp_association *asoc,
         const sctp_subtype_t type,
...
# 3809 "linux-2.6.18/net/sctp/sm_statefuns.c"
           ...
           sctp_cmd_seq_t *commands)
{
 ...
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
   SCTP_STATE(SCTP_STATE_COOKIE_WAIT));
# 3832 "linux-2.6.18/net/sctp/sm_statefuns.c"
 repl = sctp_make_init(asoc, &asoc->base.bind_addr, ((( gfp_t)0x20u)), 0);
 if (!repl)
  goto nomem;
...
# 3919 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 3957 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
{
 int disposition;
# 3974 "linux-2.6.18/net/sctp/sm_statefuns.c"
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
...
# 4019 "linux-2.6.18/net/sctp/sm_statefuns.c"
sctp_disposition_t sctp_sf_do_9_1_prm_abort(
 ...
 sctp_cmd_seq_t *commands)
{
# 4034 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
sctp_disposition_t sctp_sf_error_closed(const struct sctp_endpoint *ep,
     ...
     sctp_cmd_seq_t *commands)
{
 sctp_add_cmd_sf(commands, SCTP_CMD_REPORT_ERROR, SCTP_ERROR(-22));
 return SCTP_DISPOSITION_CONSUME;
}
...
# 4096 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4130 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4156 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4205 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4230 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4256 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4286 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4321 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4385 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4447 "linux-2.6.18/net/sctp/sm_statefuns.c"
 ...
 sctp_cmd_seq_t *commands)
{
 struct sctp_chunk *chunk = (struct sctp_chunk *) arg;
 struct sctp_chunk *reply;
# 4464 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (chunk) {
  if (!sctp_vtag_verify(chunk, asoc))
   return sctp_sf_pdiscard(ep, asoc, type, arg, commands);
...
# 4543 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4590 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4613 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4642 "linux-2.6.18/net/sctp/sm_statefuns.c"
        ...
        sctp_cmd_seq_t *commands)
{
 ...
 if (attempts <= asoc->max_init_attempts) {
  bp = (struct sctp_bind_addr *) &asoc->base.bind_addr;
  repl = sctp_make_init(asoc, bp, ((( gfp_t)0x20u)), 0);
  if (!repl)
   return SCTP_DISPOSITION_NOMEM;
...
# 4702 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4747 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4854 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
{
 int disposition;
# 4921 "linux-2.6.18/net/sctp/sm_statefuns.c"
 sctp_add_cmd_sf(commands, SCTP_CMD_NEW_STATE,
   SCTP_STATE(SCTP_STATE_SHUTDOWN_PENDING));
...
# 4950 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4967 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 4987 "linux-2.6.18/net/sctp/sm_statefuns.c"
          ...
          const struct sctp_chunk *chunk)
{
 ...
 transport = sctp_transport_new(sctp_source(chunk), ((( gfp_t)0x20u)));
 if (!transport)
  goto nomem;
    ...
    sctp_cmd_seq_t *commands)
{
 ...
 ;
# 5197 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if ((asoc->state == SCTP_STATE_ESTABLISHED) && (!chunk->data_accepted)) {
  ...
  if (asoc->ep->rcvbuf_policy)
   account_value = ((&asoc->rmem_alloc)->counter);
  else
   account_value = ((&sk->sk_rmem_alloc)->counter);
  if (account_value > sk->sk_rcvbuf) {
# 5217 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 5239 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 5297 "linux-2.6.18/net/sctp/sm_statefuns.c"
...
# 5327 "linux-2.6.18/net/sctp/sm_statefuns.c"
 if (__builtin_expect(!!(0 == datalen), 0)) {
 ...
 if (chunk->chunk_hdr->flags & SCTP_DATA_UNORDERED)
  (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_INUNORDERCHUNKS]++);
 else
  (({ (void)(0); ((*_GLOBAL_sctp_statistics_41_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))]); })->mibs[SCTP_MIB_INORDERCHUNKS]++);
# 5370 "linux-2.6.18/net/sctp/sm_statefuns.c"

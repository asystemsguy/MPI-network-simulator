...
static inline u_int64_t div64_64(u_int64_t dividend, u_int64_t divisor)
{
 ...
 if (dividend >> 32)
  ({ uint32_t __base = (d); uint32_t __rem; __rem = ((uint64_t)(dividend)) % __base; (dividend) = ((uint64_t)(dividend)) / __base; __rem; });
 else

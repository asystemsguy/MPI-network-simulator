...
static void  __attribute__ ((__section__(".exit.text"))) tcp_scalable_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_scalable[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_286_T; static  _GLOBAL_286_T  __initcall_tcp_scalable_register __attribute__((__section__(".initcall" "6" ".init")))  = tcp_scalable_register ;      ;

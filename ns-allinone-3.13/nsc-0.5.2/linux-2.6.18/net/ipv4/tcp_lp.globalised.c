...
static void  __attribute__ ((__section__(".exit.text"))) tcp_lp_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_lp[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_286_T; static  _GLOBAL_286_T  __initcall_tcp_lp_register __attribute__((__section__(".initcall" "6" ".init")))  = tcp_lp_register ;      ;

...
static void  __attribute__ ((__section__(".exit.text"))) tcp_westwood_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_westwood[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_286_T; static  _GLOBAL_286_T  __initcall_tcp_westwood_register __attribute__((__section__(".initcall" "6" ".init")))  = tcp_westwood_register ;      ;

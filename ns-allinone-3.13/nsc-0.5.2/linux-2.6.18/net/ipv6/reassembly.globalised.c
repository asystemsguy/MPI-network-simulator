...
static void ip6_frag_secret_rebuild(unsigned long dummy)
{
 ...
 for (i = 0; i < 64; i++) {
  ...
  for (p = (&(*_GLOBAL_ip6_frag_hash_41_A[get_stack_id()])[i])->first; p && ({ n = p->next; 1; }) && ({ q = ({ const typeof( ((typeof(*q) *)0)->list ) *__mptr = (p); (typeof(*q) *)( (char *)__mptr - ((size_t) &((typeof(*q) *)0)->list) );}); 1;}); p = n) {
...
static void ip6_evictor(void)
{
 ...
 while(work > 0) {
  ...
  fq = ({ const typeof( ((struct frag_queue *)0)->lru_list ) *__mptr = (tmp); (struct frag_queue *)( (char *)__mptr - ((size_t) &((struct frag_queue *)0)->lru_list) );});
...
fq_find(u32 id, struct in6_addr *src, struct in6_addr *dst)
{
 ...
 for (n = (&(*_GLOBAL_ip6_frag_hash_41_A[get_stack_id()])[hash])->first; n && ({ prefetch(n->next); 1;}) && ({ fq = ({ const typeof( ((typeof(*fq) *)0)->list ) *__mptr = (n); (typeof(*fq) *)( (char *)__mptr - ((size_t) &((typeof(*fq) *)0)->list) );}); 1;}); n = n->next) {
  if (fq->id == id &&
 ...
 if (!(fhdr->frag_off & htons(0x0001))) {
  ...
  if (end & 0x7) {
   ...
   icmpv6_param_prob(skb, 0,
       ((size_t) &((struct ipv6hdr *)0)->payload_len));
   return;
  }
  if (end > fq->len) {

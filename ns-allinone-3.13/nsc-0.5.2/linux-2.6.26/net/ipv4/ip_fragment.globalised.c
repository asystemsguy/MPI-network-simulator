...
typedef  int  _GLOBAL_232_T; static  _GLOBAL_232_T  global_sysctl_ipfrag_max_dist[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  64,  };      
...
typedef  struct inet_frags   _GLOBAL_233_T; static  _GLOBAL_233_T  global_ip4_frags[NUM_STACKS];    
...
static void ip_evictor(struct net *net)
{
 ...
 if (evicted)
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_18_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_REASMFAILS] += evicted);
}
...
static void ip_expire(unsigned long arg)
{
 ...
 (({ (void)((0)); (((*_GLOBAL_ip_statistics_18_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_REASMTIMEOUT]++);
 (({ (void)((0)); (((*_GLOBAL_ip_statistics_18_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_REASMFAILS]++);
    ...
    struct net_device *dev)
{
 ...
 (({ (void)((0)); (((*_GLOBAL_ip_statistics_18_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_REASMOKS]++);
 qp->q.fragments = ((void *)0);
 return 0;
...
int ip_defrag(struct sk_buff *skb, u32 user)
{
 ...
 (({ (void)((0)); (((*_GLOBAL_ip_statistics_18_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_REASMREQDS]++);
...
static int ip4_frags_ctl_register(struct net *net)
{
 ...
 table = (*_GLOBAL_ip4_frags_ctl_table_25_A[get_stack_id()]);
 if (net != &global_init_net[get_stack_id()]) {
  table = kmemdup(table, sizeof((*_GLOBAL_ip4_frags_ctl_table_25_A[get_stack_id()])), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (table == ((void *)0))
   goto err_alloc;
 ...
 hdr = register_net_sysctl_table(net, (*_GLOBAL_net_ipv4_ctl_path_20_A[get_stack_id()]), table);
 if (hdr == ((void *)0))
  goto err_reg;
...
typedef  struct pernet_operations   _GLOBAL_236_T; static  _GLOBAL_236_T  global_ip4_frags_ops[NUM_STACKS] = {  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  { . init  = ipv4_frags_init_net  , . exit  = ipv4_frags_exit_net   , } ,  };      

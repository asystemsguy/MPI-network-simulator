# 1 "linux-2.6.26/net/ipv4/tcp_htcp.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/tcp_htcp.c"
# 9 "linux-2.6.26/net/ipv4/tcp_htcp.c"
...
# 10 "linux-2.6.26/net/ipv4/tcp_htcp.c" 2
...
{ }
# 11 "linux-2.6.26/net/ipv4/tcp_htcp.c" 2
...
static inline  __attribute__((always_inline)) u32 htcp_cong_time(const struct htcp *ca)
{
 return global_jiffies[get_stack_id()] - ca->last_cong;
}

static inline  __attribute__((always_inline)) u32 htcp_ccount(const struct htcp *ca)
{
...
static u32 htcp_cwnd_undo(struct sock *sk)
{
 ...
 return ({ typeof(tp->snd_cwnd) _max1 = (tp->snd_cwnd); typeof((tp->snd_ssthresh << 7) / ca->beta) _max2 = ((tp->snd_ssthresh << 7) / ca->beta); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
}

static inline  __attribute__((always_inline)) void measure_rtt(struct sock *sk, u32 srtt)
{
 const struct inet_connection_sock *icsk = inet_csk(sk);
 struct htcp *ca = inet_csk_ca(sk);
...
static inline  __attribute__((always_inline)) void htcp_alpha_update(struct htcp *ca)
{
 ...
 if (global_use_rtt_scaling[get_stack_id()] && minRTT) {
  ...
  scale = ({ typeof(({ typeof(scale) _max1 = (scale); typeof(1U << 2) _max2 = (1U << 2); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; })) _min1 = (({ typeof(scale) _max1 = (scale); typeof(1U << 2) _max2 = (1U << 2); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; })); typeof(10U << 3) _min2 = (10U << 3); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
...
# 205 "linux-2.6.26/net/ipv4/tcp_htcp.c"
...
static u32 htcp_recalc_ssthresh(struct sock *sk)
{
 ...
 return ({ typeof((tp->snd_cwnd * ca->beta) >> 7) _max1 = ((tp->snd_cwnd * ca->beta) >> 7); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
}

...
typedef  struct resource   _GLOBAL_123_T; extern  _GLOBAL_123_T  global_ioport_resource[NUM_STACKS];    
typedef  struct resource   _GLOBAL_124_T; extern  _GLOBAL_124_T  global_iomem_resource[NUM_STACKS];    
...
typedef  void   ( *_GLOBAL_126_T  )  ( void  ) ; extern  _GLOBAL_126_T global_pm_idle[NUM_STACKS];   
typedef  void   ( *_GLOBAL_128_T  )  ( void  ) ; extern  _GLOBAL_128_T global_pm_power_off[NUM_STACKS];   
typedef  void   ( *_GLOBAL_130_T  )  ( void  ) ; extern  _GLOBAL_130_T global_pm_power_off_prepare[NUM_STACKS];   
...
typedef  unsigned int   _GLOBAL_131_T; extern  _GLOBAL_131_T  global_pm_flags[NUM_STACKS];    
...
{
 typedef  struct lock_class_key   _GLOBAL_132_T; static  _GLOBAL_132_T  global___key[NUM_STACKS];    
...
typedef  int   ( *_GLOBAL_134_T  )  ( struct device   * dev   ) ; extern  _GLOBAL_134_T global_platform_notify[NUM_STACKS];     

typedef  int   ( *_GLOBAL_136_T  )  ( struct device   * dev   ) ; extern  _GLOBAL_136_T global_platform_notify_remove[NUM_STACKS];     

...
typedef  const struct in6_addr    _GLOBAL_105_T; extern  _GLOBAL_105_T  global_in6addr_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_106_T; extern  _GLOBAL_106_T  global_in6addr_loopback[NUM_STACKS];     

...
m2sm(u32 m)
{
 ...
 sm = ((u64)m << 20);
 sm += ((1000000000L) >> 10) - 1;
 ({ uint32_t __base = (((1000000000L) >> 10)); uint32_t __rem; __rem = ((uint64_t)(sm)) % __base; (sm) = ((uint64_t)(sm)) / __base; __rem; });
 return sm;
}
...
dx2d(u64 dx)
{
 ...
 d = dx * 1000000L;
 ({ uint32_t __base = (((1000000000L) >> 10)); uint32_t __rem; __rem = ((uint64_t)(d)) % __base; (d) = ((uint64_t)(d)) / __base; __rem; });
 return (u32)d;
}
...
hfsc_adjust_levels(struct hfsc_class *cl)
{
 ...
 do {
  level = 0;
  for (p = ({ const typeof( ((typeof(*p) *)0)->siblings ) *__mptr = ((&cl->children)->next); (typeof(*p) *)( (char *)__mptr - __builtin_offsetof(typeof(*p),siblings) );}); __builtin_prefetch(p->siblings.next), &p->siblings != (&cl->children); p = ({ const typeof( ((typeof(*p) *)0)->siblings ) *__mptr = (p->siblings.next); (typeof(*p) *)( (char *)__mptr - __builtin_offsetof(typeof(*p),siblings) );})) {
   if (p->level >= level)
    level = p->level + 1;
  }
  cl->level = level;
...
typedef  const struct nla_policy    _GLOBAL_153_T; static  _GLOBAL_153_T  _GLOBAL_0_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_1_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_2_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_3_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_4_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_5_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_6_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_7_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_8_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_9_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_10_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_11_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_12_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_13_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_14_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_15_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_16_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_17_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_18_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_19_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_20_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_21_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_22_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_23_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_24_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_25_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_26_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_27_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_28_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_29_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_30_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_31_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_32_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_33_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_34_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_35_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_36_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_37_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_38_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_39_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_40_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_41_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_42_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_43_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_44_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_45_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_46_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_47_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_48_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_49_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_hfsc_policy_I) *_GLOBAL_hfsc_policy_12_A[NUM_STACKS] = { &_GLOBAL_0_hfsc_policy_I, &_GLOBAL_1_hfsc_policy_I, &_GLOBAL_2_hfsc_policy_I, &_GLOBAL_3_hfsc_policy_I, &_GLOBAL_4_hfsc_policy_I, &_GLOBAL_5_hfsc_policy_I, &_GLOBAL_6_hfsc_policy_I, &_GLOBAL_7_hfsc_policy_I, &_GLOBAL_8_hfsc_policy_I, &_GLOBAL_9_hfsc_policy_I, &_GLOBAL_10_hfsc_policy_I, &_GLOBAL_11_hfsc_policy_I, &_GLOBAL_12_hfsc_policy_I, &_GLOBAL_13_hfsc_policy_I, &_GLOBAL_14_hfsc_policy_I, &_GLOBAL_15_hfsc_policy_I, &_GLOBAL_16_hfsc_policy_I, &_GLOBAL_17_hfsc_policy_I, &_GLOBAL_18_hfsc_policy_I, &_GLOBAL_19_hfsc_policy_I, &_GLOBAL_20_hfsc_policy_I, &_GLOBAL_21_hfsc_policy_I, &_GLOBAL_22_hfsc_policy_I, &_GLOBAL_23_hfsc_policy_I, &_GLOBAL_24_hfsc_policy_I, &_GLOBAL_25_hfsc_policy_I, &_GLOBAL_26_hfsc_policy_I, &_GLOBAL_27_hfsc_policy_I, &_GLOBAL_28_hfsc_policy_I, &_GLOBAL_29_hfsc_policy_I, &_GLOBAL_30_hfsc_policy_I, &_GLOBAL_31_hfsc_policy_I, &_GLOBAL_32_hfsc_policy_I, &_GLOBAL_33_hfsc_policy_I, &_GLOBAL_34_hfsc_policy_I, &_GLOBAL_35_hfsc_policy_I, &_GLOBAL_36_hfsc_policy_I, &_GLOBAL_37_hfsc_policy_I, &_GLOBAL_38_hfsc_policy_I, &_GLOBAL_39_hfsc_policy_I, &_GLOBAL_40_hfsc_policy_I, &_GLOBAL_41_hfsc_policy_I, &_GLOBAL_42_hfsc_policy_I, &_GLOBAL_43_hfsc_policy_I, &_GLOBAL_44_hfsc_policy_I, &_GLOBAL_45_hfsc_policy_I, &_GLOBAL_46_hfsc_policy_I, &_GLOBAL_47_hfsc_policy_I, &_GLOBAL_48_hfsc_policy_I, &_GLOBAL_49_hfsc_policy_I, };          
    ...
    struct nlattr **tca, unsigned long *arg)
{
 ...
 err = nla_parse_nested(tb, (__TCA_HFSC_MAX - 1), opt, (*_GLOBAL_hfsc_policy_12_A[get_stack_id()]));
 if (err < 0)
  return err;
...
hfsc_walk(struct Qdisc *sch, struct qdisc_walker *arg)
{
 ...
 for (i = 0; i < 16; i++) {
  for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[i])->next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );}); __builtin_prefetch(cl->hlist.next), &cl->hlist != (&q->clhash[i]); cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );})) {
...
hfsc_drop(struct Qdisc *sch)
{
 ...
 for (cl = ({ const typeof( ((typeof(*cl) *)0)->dlist ) *__mptr = ((&q->droplist)->next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),dlist) );}); __builtin_prefetch(cl->dlist.next), &cl->dlist != (&q->droplist); cl = ({ const typeof( ((typeof(*cl) *)0)->dlist ) *__mptr = (cl->dlist.next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),dlist) );})) {

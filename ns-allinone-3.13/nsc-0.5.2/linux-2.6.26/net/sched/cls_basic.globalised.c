...
typedef  const struct tcf_ext_map    _GLOBAL_153_T; static  _GLOBAL_153_T  global_basic_ext_map[NUM_STACKS] = {  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  };       
     ...
     struct tcf_result *res)
{
 ...
 for (f = ({ const typeof( ((typeof(*f) *)0)->link ) *__mptr = ((&head->flist)->next); (typeof(*f) *)( (char *)__mptr - __builtin_offsetof(typeof(*f),link) );}); __builtin_prefetch(f->link.next), &f->link != (&head->flist); f = ({ const typeof( ((typeof(*f) *)0)->link ) *__mptr = (f->link.next); (typeof(*f) *)( (char *)__mptr - __builtin_offsetof(typeof(*f),link) );})) {
  if (!((void)(((void *)0)), 1))
   continue;
  *res = f->res;
...
static int basic_delete(struct tcf_proto *tp, unsigned long arg)
{
 ...
 for (t = ({ const typeof( ((typeof(*t) *)0)->link ) *__mptr = ((&head->flist)->next); (typeof(*t) *)( (char *)__mptr - __builtin_offsetof(typeof(*t),link) );}); __builtin_prefetch(t->link.next), &t->link != (&head->flist); t = ({ const typeof( ((typeof(*t) *)0)->link ) *__mptr = (t->link.next); (typeof(*t) *)( (char *)__mptr - __builtin_offsetof(typeof(*t),link) );}))
  if (t == f) {
   qdisc_lock_tree((tp)->q->dev);
   list_del(&t->link);
   qdisc_unlock_tree((tp)->q->dev);
...
typedef  const struct nla_policy    _GLOBAL_154_T; static  _GLOBAL_154_T  _GLOBAL_0_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_1_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_2_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_3_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_4_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_5_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_6_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_7_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_8_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_9_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_10_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_11_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_12_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_13_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_14_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_15_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_16_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_17_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_18_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_19_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_20_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_21_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_22_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_23_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_24_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_25_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_26_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_27_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_28_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_29_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_30_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_31_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_32_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_33_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_34_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_35_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_36_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_37_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_38_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_39_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_40_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_41_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_42_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_43_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_44_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_45_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_46_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_47_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_48_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_154_T  _GLOBAL_49_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_basic_policy_I) *_GLOBAL_basic_policy_12_A[NUM_STACKS] = { &_GLOBAL_0_basic_policy_I, &_GLOBAL_1_basic_policy_I, &_GLOBAL_2_basic_policy_I, &_GLOBAL_3_basic_policy_I, &_GLOBAL_4_basic_policy_I, &_GLOBAL_5_basic_policy_I, &_GLOBAL_6_basic_policy_I, &_GLOBAL_7_basic_policy_I, &_GLOBAL_8_basic_policy_I, &_GLOBAL_9_basic_policy_I, &_GLOBAL_10_basic_policy_I, &_GLOBAL_11_basic_policy_I, &_GLOBAL_12_basic_policy_I, &_GLOBAL_13_basic_policy_I, &_GLOBAL_14_basic_policy_I, &_GLOBAL_15_basic_policy_I, &_GLOBAL_16_basic_policy_I, &_GLOBAL_17_basic_policy_I, &_GLOBAL_18_basic_policy_I, &_GLOBAL_19_basic_policy_I, &_GLOBAL_20_basic_policy_I, &_GLOBAL_21_basic_policy_I, &_GLOBAL_22_basic_policy_I, &_GLOBAL_23_basic_policy_I, &_GLOBAL_24_basic_policy_I, &_GLOBAL_25_basic_policy_I, &_GLOBAL_26_basic_policy_I, &_GLOBAL_27_basic_policy_I, &_GLOBAL_28_basic_policy_I, &_GLOBAL_29_basic_policy_I, &_GLOBAL_30_basic_policy_I, &_GLOBAL_31_basic_policy_I, &_GLOBAL_32_basic_policy_I, &_GLOBAL_33_basic_policy_I, &_GLOBAL_34_basic_policy_I, &_GLOBAL_35_basic_policy_I, &_GLOBAL_36_basic_policy_I, &_GLOBAL_37_basic_policy_I, &_GLOBAL_38_basic_policy_I, &_GLOBAL_39_basic_policy_I, &_GLOBAL_40_basic_policy_I, &_GLOBAL_41_basic_policy_I, &_GLOBAL_42_basic_policy_I, &_GLOBAL_43_basic_policy_I, &_GLOBAL_44_basic_policy_I, &_GLOBAL_45_basic_policy_I, &_GLOBAL_46_basic_policy_I, &_GLOBAL_47_basic_policy_I, &_GLOBAL_48_basic_policy_I, &_GLOBAL_49_basic_policy_I, };          
   ...
   struct nlattr **tca, unsigned long *arg)
{
 ...
 err = nla_parse_nested(tb, (__TCA_BASIC_MAX - 1), tca[TCA_OPTIONS],
          (*_GLOBAL_basic_policy_12_A[get_stack_id()]));
 if (err < 0)
  return err;

...
typedef  const struct nla_policy    _GLOBAL_153_T; static  _GLOBAL_153_T  _GLOBAL_0_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_1_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_2_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_3_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_4_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_5_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_6_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_7_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_8_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_9_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_10_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_11_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_12_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_13_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_14_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_15_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_16_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_17_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_18_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_19_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_20_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_21_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_22_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_23_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_24_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_25_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_26_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_27_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_28_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_29_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_30_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_31_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_32_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_33_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_34_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_35_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_36_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_37_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_38_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_39_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_40_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_41_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_42_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_43_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_44_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_45_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_46_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_47_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_48_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_49_netem_policy_I [ ( __TCA_NETEM_MAX - 1  )  + 1  ]  = { [ TCA_NETEM_CORR ] = { . len  = sizeof ( struct tc_netem_corr  )   }  , [ TCA_NETEM_REORDER ] = { . len  = sizeof ( struct tc_netem_reorder  )   }   , [ TCA_NETEM_CORRUPT ] = { . len  = sizeof ( struct tc_netem_corrupt  )   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_netem_policy_I) *_GLOBAL_netem_policy_12_A[NUM_STACKS] = { &_GLOBAL_0_netem_policy_I, &_GLOBAL_1_netem_policy_I, &_GLOBAL_2_netem_policy_I, &_GLOBAL_3_netem_policy_I, &_GLOBAL_4_netem_policy_I, &_GLOBAL_5_netem_policy_I, &_GLOBAL_6_netem_policy_I, &_GLOBAL_7_netem_policy_I, &_GLOBAL_8_netem_policy_I, &_GLOBAL_9_netem_policy_I, &_GLOBAL_10_netem_policy_I, &_GLOBAL_11_netem_policy_I, &_GLOBAL_12_netem_policy_I, &_GLOBAL_13_netem_policy_I, &_GLOBAL_14_netem_policy_I, &_GLOBAL_15_netem_policy_I, &_GLOBAL_16_netem_policy_I, &_GLOBAL_17_netem_policy_I, &_GLOBAL_18_netem_policy_I, &_GLOBAL_19_netem_policy_I, &_GLOBAL_20_netem_policy_I, &_GLOBAL_21_netem_policy_I, &_GLOBAL_22_netem_policy_I, &_GLOBAL_23_netem_policy_I, &_GLOBAL_24_netem_policy_I, &_GLOBAL_25_netem_policy_I, &_GLOBAL_26_netem_policy_I, &_GLOBAL_27_netem_policy_I, &_GLOBAL_28_netem_policy_I, &_GLOBAL_29_netem_policy_I, &_GLOBAL_30_netem_policy_I, &_GLOBAL_31_netem_policy_I, &_GLOBAL_32_netem_policy_I, &_GLOBAL_33_netem_policy_I, &_GLOBAL_34_netem_policy_I, &_GLOBAL_35_netem_policy_I, &_GLOBAL_36_netem_policy_I, &_GLOBAL_37_netem_policy_I, &_GLOBAL_38_netem_policy_I, &_GLOBAL_39_netem_policy_I, &_GLOBAL_40_netem_policy_I, &_GLOBAL_41_netem_policy_I, &_GLOBAL_42_netem_policy_I, &_GLOBAL_43_netem_policy_I, &_GLOBAL_44_netem_policy_I, &_GLOBAL_45_netem_policy_I, &_GLOBAL_46_netem_policy_I, &_GLOBAL_47_netem_policy_I, &_GLOBAL_48_netem_policy_I, &_GLOBAL_49_netem_policy_I, };          
...
static int netem_change(struct Qdisc *sch, struct nlattr *opt)
{
 ...
 ret = ({ qopt = nla_len(opt) >= sizeof(*qopt) ? nla_data(opt) : ((void *)0); __nla_parse_nested_compat(tb, (__TCA_NETEM_MAX - 1), opt, (*_GLOBAL_netem_policy_12_A[get_stack_id()]), sizeof(*qopt)); })
                              ;
 if (ret < 0)
  return ret;
...
static int tfifo_enqueue(struct sk_buff *nskb, struct Qdisc *sch)
{
 ...
 if (__builtin_expect(!!(skb_queue_len(list) < q->limit), 1)) {
  ...
  for (skb = (list)->prev; __builtin_prefetch(skb->prev), (skb != (struct sk_buff *)(list)); skb = skb->prev) {
   const struct netem_skb_cb *cb
    = (const struct netem_skb_cb *)skb->cb;

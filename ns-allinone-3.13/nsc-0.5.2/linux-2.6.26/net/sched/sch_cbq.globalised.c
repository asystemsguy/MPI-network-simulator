...
static void cbq_ovl_delay(struct cbq_class *cl)
{
 ...
 if (!cl->delayed) {
  ...
  if (delay > 0) {
   ...
   expires = ({ (ktime_t){ .tv64 = (expires).tv64 + (((s64)(sched) << 10)) }; });
   if (hrtimer_try_to_cancel(&q->delay_timer) &&
       ((({ (ktime_t){ .tv64 = (q->delay_timer.expires).tv64 - (expires).tv64 }; })).tv64)
                  > 0)
...
static enum hrtimer_restart cbq_undelay(struct hrtimer *timer)
{
 ...
 if (delay) {
  ...
  time = ktime_set(0, 0);
  time = ({ (ktime_t){ .tv64 = (time).tv64 + (((s64)(now + delay) << 10)) }; });
...
typedef  const struct nla_policy    _GLOBAL_153_T; static  _GLOBAL_153_T  _GLOBAL_0_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_1_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_2_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_3_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_4_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_5_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_6_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_7_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_8_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_9_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_10_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_11_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_12_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_13_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_14_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_15_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_16_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_17_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_18_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_19_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_20_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_21_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_22_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_23_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_24_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_25_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_26_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_27_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_28_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_29_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_30_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_31_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_32_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_33_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_34_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_35_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_36_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_37_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_38_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_39_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_40_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_41_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_42_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_43_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_44_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_45_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_46_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_47_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_48_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static  _GLOBAL_153_T  _GLOBAL_49_cbq_policy_I [ ( __TCA_CBQ_MAX - 1  )  + 1  ]  = { [ TCA_CBQ_LSSOPT ] = { . len  = sizeof ( struct tc_cbq_lssopt  )   }  , [ TCA_CBQ_WRROPT ] = { . len  = sizeof ( struct tc_cbq_wrropt  )   }   , [ TCA_CBQ_FOPT ] = { . len  = sizeof ( struct tc_cbq_fopt  )   }   , [ TCA_CBQ_OVL_STRATEGY ] = { . len  = sizeof ( struct tc_cbq_ovl  )   }   , [ TCA_CBQ_RATE ] = { . len  = sizeof ( struct tc_ratespec  )   }   , [ TCA_CBQ_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_CBQ_POLICE ] = { . len  = sizeof ( struct tc_cbq_police  )   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_cbq_policy_I) *_GLOBAL_cbq_policy_12_A[NUM_STACKS] = { &_GLOBAL_0_cbq_policy_I, &_GLOBAL_1_cbq_policy_I, &_GLOBAL_2_cbq_policy_I, &_GLOBAL_3_cbq_policy_I, &_GLOBAL_4_cbq_policy_I, &_GLOBAL_5_cbq_policy_I, &_GLOBAL_6_cbq_policy_I, &_GLOBAL_7_cbq_policy_I, &_GLOBAL_8_cbq_policy_I, &_GLOBAL_9_cbq_policy_I, &_GLOBAL_10_cbq_policy_I, &_GLOBAL_11_cbq_policy_I, &_GLOBAL_12_cbq_policy_I, &_GLOBAL_13_cbq_policy_I, &_GLOBAL_14_cbq_policy_I, &_GLOBAL_15_cbq_policy_I, &_GLOBAL_16_cbq_policy_I, &_GLOBAL_17_cbq_policy_I, &_GLOBAL_18_cbq_policy_I, &_GLOBAL_19_cbq_policy_I, &_GLOBAL_20_cbq_policy_I, &_GLOBAL_21_cbq_policy_I, &_GLOBAL_22_cbq_policy_I, &_GLOBAL_23_cbq_policy_I, &_GLOBAL_24_cbq_policy_I, &_GLOBAL_25_cbq_policy_I, &_GLOBAL_26_cbq_policy_I, &_GLOBAL_27_cbq_policy_I, &_GLOBAL_28_cbq_policy_I, &_GLOBAL_29_cbq_policy_I, &_GLOBAL_30_cbq_policy_I, &_GLOBAL_31_cbq_policy_I, &_GLOBAL_32_cbq_policy_I, &_GLOBAL_33_cbq_policy_I, &_GLOBAL_34_cbq_policy_I, &_GLOBAL_35_cbq_policy_I, &_GLOBAL_36_cbq_policy_I, &_GLOBAL_37_cbq_policy_I, &_GLOBAL_38_cbq_policy_I, &_GLOBAL_39_cbq_policy_I, &_GLOBAL_40_cbq_policy_I, &_GLOBAL_41_cbq_policy_I, &_GLOBAL_42_cbq_policy_I, &_GLOBAL_43_cbq_policy_I, &_GLOBAL_44_cbq_policy_I, &_GLOBAL_45_cbq_policy_I, &_GLOBAL_46_cbq_policy_I, &_GLOBAL_47_cbq_policy_I, &_GLOBAL_48_cbq_policy_I, &_GLOBAL_49_cbq_policy_I, };          
...
static int cbq_init(struct Qdisc *sch, struct nlattr *opt)
{
 ...
 err = nla_parse_nested(tb, (__TCA_CBQ_MAX - 1), opt, (*_GLOBAL_cbq_policy_12_A[get_stack_id()]));
 if (err < 0)
  return err;

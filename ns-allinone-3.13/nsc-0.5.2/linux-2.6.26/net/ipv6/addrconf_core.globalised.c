...
typedef  char  _GLOBAL_23_T; extern  _GLOBAL_23_T  * global_saved_command_line[NUM_STACKS];   
typedef  unsigned int   _GLOBAL_24_T; extern  _GLOBAL_24_T  global_reset_devices[NUM_STACKS];    


void setup_arch(char **);
void prepare_namespace(void);

typedef  void   ( *_GLOBAL_26_T  )  ( void  ) ; extern  _GLOBAL_26_T global_late_time_init[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_27_T; static  _GLOBAL_27_T  global___force_order[NUM_STACKS];    
...
typedef  int  _GLOBAL_28_T; extern  _GLOBAL_28_T  global_es7000_plat[NUM_STACKS];   
...
typedef  __typeof__ ( struct x8664_pda  )   _GLOBAL_29_T; extern  _GLOBAL_29_T  global_per_cpu__pda[NUM_STACKS];    
...
typedef  cpumask_t  _GLOBAL_30_T; extern  _GLOBAL_30_T  global_cpu_possible_map[NUM_STACKS];   
typedef  cpumask_t  _GLOBAL_31_T; extern  _GLOBAL_31_T  global_cpu_online_map[NUM_STACKS];   
typedef  cpumask_t  _GLOBAL_32_T; extern  _GLOBAL_32_T  global_cpu_present_map[NUM_STACKS];   
...
typedef  struct cpuinfo_x86   _GLOBAL_33_T; extern  _GLOBAL_33_T  global_boot_cpu_data[NUM_STACKS];    
typedef  struct cpuinfo_x86   _GLOBAL_34_T; extern  _GLOBAL_34_T  global_new_cpu_data[NUM_STACKS];    
...
typedef  __typeof__ ( struct tss_struct  )   _GLOBAL_36_T; extern  _GLOBAL_36_T  global_per_cpu__init_tss[NUM_STACKS];    
...
typedef  __typeof__ ( struct orig_ist  )   _GLOBAL_37_T; extern  _GLOBAL_37_T  global_per_cpu__orig_ist[NUM_STACKS];    


extern void print_cpu_info(struct cpuinfo_x86 *);
typedef  unsigned int   _GLOBAL_38_T; extern  _GLOBAL_38_T  global_xstate_size[NUM_STACKS];    
extern void free_thread_xstate(struct task_struct *);
extern struct kmem_cache *task_xstate_cachep;
extern void init_scattered_cpuid_features(struct cpuinfo_x86 *c);
extern unsigned int init_intel_cacheinfo(struct cpuinfo_x86 *c);
typedef  unsigned short   _GLOBAL_39_T; extern  _GLOBAL_39_T  global_num_cache_leaves[NUM_STACKS];    
...
typedef  unsigned long   _GLOBAL_40_T; extern  _GLOBAL_40_T  global_mmu_cr4_features[NUM_STACKS];    
...
typedef  int  _GLOBAL_41_T; extern  _GLOBAL_41_T  global_force_mwait[NUM_STACKS];   

extern void select_idle_routine(const struct cpuinfo_x86 *c);

typedef  unsigned long   _GLOBAL_42_T; extern  _GLOBAL_42_T  global_boot_option_idle_override[NUM_STACKS];    

extern void enable_sep_cpu(void);
extern int sysenter_setup(void);


typedef  struct desc_ptr   _GLOBAL_43_T; extern  _GLOBAL_43_T  global_early_gdt_descr[NUM_STACKS];    
...
typedef  unsigned int   _GLOBAL_44_T; extern  _GLOBAL_44_T  global_machine_id[NUM_STACKS];    
typedef  unsigned int   _GLOBAL_45_T; extern  _GLOBAL_45_T  global_machine_submodel_id[NUM_STACKS];    
typedef  unsigned int   _GLOBAL_46_T; extern  _GLOBAL_46_T  global_BIOS_revision[NUM_STACKS];    


typedef  int  _GLOBAL_47_T; extern  _GLOBAL_47_T  global_bootloader_type[NUM_STACKS];   

typedef  char  _GLOBAL_48_T; extern  _GLOBAL_48_T  global_ignore_fpu_irq[NUM_STACKS];   
...
typedef  struct timespec   _GLOBAL_49_T; extern  _GLOBAL_49_T  global_xtime[NUM_STACKS];    
typedef  struct timespec   _GLOBAL_50_T; extern  _GLOBAL_50_T  global_wall_to_monotonic[NUM_STACKS];    
typedef  seqlock_t  _GLOBAL_51_T; extern  _GLOBAL_51_T  global_xtime_lock[NUM_STACKS];   

extern unsigned long read_persistent_clock(void);
extern int update_persistent_clock(struct timespec now);
typedef  int  _GLOBAL_52_T; extern  _GLOBAL_52_T  global_no_sync_cmos_clock[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;    
...
typedef  int  _GLOBAL_54_T; extern  _GLOBAL_54_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_55_T; extern  _GLOBAL_55_T  global_net_msg_burst[NUM_STACKS];   

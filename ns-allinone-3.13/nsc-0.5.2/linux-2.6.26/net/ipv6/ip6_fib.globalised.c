...
# 29 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
typedef  struct kmem_cache   _GLOBAL_229_T; static  _GLOBAL_229_T  * global_fib6_node_kmem[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;      
...
typedef  rwlock_t  _GLOBAL_230_T; static  _GLOBAL_230_T  global_fib6_walker_lock[NUM_STACKS] = {  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  };           
...
static int inet6_dump_fib(struct sk_buff *skb, struct netlink_callback *cb)
{
 ...
 for (h = s_h; h < 1; h++, s_e = 0) {
  ...
  for (node = (head)->first; node && ({ __builtin_prefetch(node->next); 1;}) && ({ tb = ({ const typeof( ((typeof(*tb) *)0)->tb6_hlist ) *__mptr = (node); (typeof(*tb) *)( (char *)__mptr - __builtin_offsetof(typeof(*tb),tb6_hlist) );}); 1;}); node = node->next) {
   if (e < s_e)
    goto next;
      ...
      int prune, void *arg)
{
 ...
 for (h = 0; h < 1; h++) {
  head = &net->ipv6.fib_table_hash[h];
  for (node = ({ typeof((head)->first) _________p1 = (*(volatile typeof((head)->first) *)&((head)->first)); do { } while (0); (_________p1); }); node && ({ __builtin_prefetch(node->next); 1;}) && ({ table = ({ const typeof( ((typeof(*table) *)0)->tb6_hlist ) *__mptr = (node); (typeof(*table) *)( (char *)__mptr - __builtin_offsetof(typeof(*table),tb6_hlist) );}); 1;}); node = ({ typeof(node->next) _________p1 = (*(volatile typeof(node->next) *)&(node->next)); do { } while (0); (_________p1); })) {
   do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&table->tb6_lock); } while (0); } while (0);
...
typedef  struct fib6_gc_args { int  timeout ;  int  more ;   }   _GLOBAL_233_T; static  _GLOBAL_233_T  global_gc_args[NUM_STACKS];   
...
typedef  spinlock_t  _GLOBAL_234_T; static  _GLOBAL_234_T  global_fib6_gc_lock[NUM_STACKS] = {  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  };           
...
typedef  struct pernet_operations   _GLOBAL_235_T; static  _GLOBAL_235_T  global_fib6_net_ops[NUM_STACKS] = {  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  };      

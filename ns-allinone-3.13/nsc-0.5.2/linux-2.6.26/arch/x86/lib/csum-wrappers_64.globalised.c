# 1 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c"
...
# 10 "linux-2.6.26/include/asm/checksum_64.h"
...
# 11 "linux-2.6.26/include/asm/checksum_64.h" 2
...
# 8 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c" 2
...
{ }
# 9 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c" 2
# 21 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c"
__wsum
 ...
 *errp = 0;
 ...
 if (!__builtin_expect(!!((1)), 1))
  goto out_err;
# 39 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c"
 if (__builtin_expect(!!((unsigned long)src & 6), 0)) {
  while (((unsigned long)src & 6) && len >= 2) {
   __u16 val16;

   *errp = ({ int __gu_err; unsigned long __gu_val; do { __gu_err = 0; (void)0; switch ((sizeof(*((const __u16 *)src)))) { case 1: asm volatile("1:	mov""b"" %2,%""b""1\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	xor""b"" %""b""1,%""b""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=q" (__gu_val) : "m" ((*(struct __large_struct *)((((const __u16 *)src))))), "i"(-14), "0"(__gu_err)); break; case 2: asm volatile("1:	mov""w"" %2,%""w""1\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	xor""w"" %""w""1,%""w""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=r" (__gu_val) : "m" ((*(struct __large_struct *)((((const __u16 *)src))))), "i"(-14), "0"(__gu_err)); break; case 4: asm volatile("1:	mov""l"" %2,%""k""1\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	xor""l"" %""k""1,%""k""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=r" (__gu_val) : "m" ((*(struct __large_struct *)((((const __u16 *)src))))), "i"(-14), "0"(__gu_err)); break; case 8: asm volatile("1:	mov""q"" %2,%""""1\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	xor""q"" %""""1,%""""1\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r" (__gu_err), "=r" (__gu_val) : "m" ((*(struct __large_struct *)((((const __u16 *)src))))), "i"(-14), "0"(__gu_err)); break; default: (__gu_val) = __get_user_bad(); } } while (0); ((val16)) = ( typeof(*(((const __u16 *)src))))__gu_val; __gu_err; });
   if (*errp)
    return isum;

   *(__u16 *)dst = val16;
   isum = ( __wsum)add32_with_carry(
     ( unsigned)isum, val16);
   src += 2;
   dst += 2;
   len -= 2;
 ...
 isum = csum_partial_copy_generic(( const void *)src,
    dst, len, isum, errp, ((void *)0));
 if (__builtin_expect(!!(*errp), 0))
  goto out_err;
...
;
# 81 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c"
__wsum
csum_partial_copy_to_user(const void *src, void *dst,
     int len, __wsum isum, int *errp)
{
 do { do { } while (0); } while (0);
 ...
 if (__builtin_expect(!!((unsigned long)dst & 6), 0)) {
  while (((unsigned long)dst & 6) && len >= 2) {
   __u16 val16 = *(__u16 *)src;

   isum = ( __wsum)add32_with_carry(
     ( unsigned)isum, val16);
   *errp = ({ int __pu_err; do { __pu_err = 0; (void)0; switch ((sizeof(*((__u16 *)dst)))) { case 1: asm volatile("1:	mov""b"" %""b""1,%2\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r"(__pu_err) : "iq" (((__typeof__(*((__u16 *)dst)))(val16))), "m" ((*(struct __large_struct *)((((__u16 *)dst))))), "i" (-14), "0" (__pu_err)); break; case 2: asm volatile("1:	mov""w"" %""w""1,%2\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r"(__pu_err) : "ir" (((__typeof__(*((__u16 *)dst)))(val16))), "m" ((*(struct __large_struct *)((((__u16 *)dst))))), "i" (-14), "0" (__pu_err)); break; case 4: asm volatile("1:	mov""l"" %""k""1,%2\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r"(__pu_err) : "ir" (((__typeof__(*((__u16 *)dst)))(val16))), "m" ((*(struct __large_struct *)((((__u16 *)dst))))), "i" (-14), "0" (__pu_err)); break; case 8: asm volatile("1:	mov""q"" %""""1,%2\n" "2:\n" ".section .fixup, \"ax\"\n" "3:	mov %3,%0\n" "	jmp 2b\n" ".previous\n" " .section __ex_table,\"a\"\n" " .balign 8 " "\n" " .quad " "1b" "," "3b" "\n" " .previous\n" : "=r"(__pu_err) : "Zr" (((__typeof__(*((__u16 *)dst)))(val16))), "m" ((*(struct __large_struct *)((((__u16 *)dst))))), "i" (-14), "0" (__pu_err)); break; default: __put_user_bad(); } } while (0); __pu_err; });
   if (*errp)
    return isum;
   src += 2;
   dst += 2;
 ...
 *errp = 0;
 return csum_partial_copy_generic(src, (void *)dst,
      len, isum, ((void *)0), errp);
}
;
# 122 "linux-2.6.26/arch/x86/lib/csum-wrappers_64.c"
__wsum
   ...
   __u32 len, unsigned short proto, __wsum sum)
{
 ...
 rest = ( __u64)(( __be32)__fswab32((len))) + ( __u64)(( __be16)__fswab16((proto))) +
  ( __u64)sum;
 ...
 return csum_fold(
        ( __wsum)add32_with_carry(sum64 & 0xffffffff, sum64>>32));
}
;
